...
oarsub -p "gpu='YES' and gpumem>30000 and gpucapability>='8.0'" -l /nodes=1/gpunum=1,walltime=01:00:00  -t besteffort --stdout=../data/OARoutput/OAR.%jobid%.stdout --stderr=../data/OARoutput/OAR.%jobid%.stderr -I ./python_exec
