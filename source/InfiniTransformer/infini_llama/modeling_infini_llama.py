...
from transformers.models.llama.modeling_llama import LlamaRotaryEmbedding as TransformersRotEmbedds
    ...
    def _init_rope(self):
        if self.config.rope_scaling is None:
            ...
            if scaling_type == "linear":
                ...
                self.rotary_emb = TransformersRotEmbedds(config=self.config)
    def forward(
        self,
...
class LlamaInfiniAttention(LlamaAttention):
    ...
    def _update_memory(self, key_states, value_states, memory, norm_term):
        ...
        #print("[Update] self.memory.shape", memory.shape)
        #print("[Update] self.norm_term.shape", norm_term.shape)
